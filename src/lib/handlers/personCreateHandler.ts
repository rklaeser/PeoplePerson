    ...
    try {
      ...
      if (!personData.name) {
        return {
          ...
          success: false,
          action: 'error',
          message: 'I could not determine the person\'s name. Please include a name when creating a new friend.',
          people: []
        };
      }
      ...
      const uniqueExisting = allExisting.filter((friend, index, array) => 
