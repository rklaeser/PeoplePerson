...
from ..auth import get_current_user_no_test_bypass, get_user_friends
...
from ..schemas.ai import ChatRequest, ChatMessage
from ..workflows.graph import create_person_workflow
...
async def event_generator(text: str, user_id: str) -> AsyncGenerator[str, None]:
    ...
    initial_state = {
        "text": text,
        "user_id": user_id,
        "all_friends": await get_user_friends(user_id),
        "annotations": [],
        "result_people": [],
        "success": False
    }
